...
public class WhiteTestService {
	...
	public WhiteTestResponse CheckExamCode(StudentRequest studentRequest) throws DatatypeConfigurationException {
		...
		Address ad = new Address("ariena","soghra",1112);
		...
		Student s1=new Student(1,"moatez",ad);
		Student s2=new Student(2,"taaz",ad);
		Student s3=new Student(3,"omar",ad);
		...
		Student errorStudent = new Student (-1, "falseName",ad);
